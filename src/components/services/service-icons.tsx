...
/** Icons for marketing service cards and detail pages (matches `Service.icon`). */
  ...
  globe: (
    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path
        ...
        d="M12 21a9 9 0 1 0 0-18m0 18c2.5 0 4.5-4.03 4.5-9S14.5 3 12 3m0 18c-2.5 0-4.5-4.03-4.5-9S9.5 3 12 3M3.6 9h16.8M3.6 15h16.8"
      />
    </svg>
  ),
  brain: (
