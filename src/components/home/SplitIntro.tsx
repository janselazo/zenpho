...
const cards = [
  {
    ...
    titleAccent: "",
    body: "We design and build custom websites, web apps, and mobile apps tailored to your business.",
    href: "/services",
  ...
  },
  {
    ...
    titleAccent: "",
    body: "Whether you're a tech or non-tech founder, we turn your idea into a fully functional software product.",
    href: "/services",
    cta: "Explore services",
    initial: "L",
  },
  {
    ...
    titleAccent: "",
    body: "The AI Product Studio is our internal lab where we design, build, and launch our own software products, turning our ideas into real tools.",
    href: "/studio",
    cta: "Open Studio",
    initial: "S",
  },
