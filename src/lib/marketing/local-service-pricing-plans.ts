...
export const localServicePricingPlans: LocalServicePricingPlan[] = [
  {
    ...
    planTagline: "BUSINESS & ECOMMERCE WEBSITES",
    headerNote:
      "Professional website or ecommerce storefront built to explain your offer, build trust, and convert visitors into customers.",
    priceLead: "$2,497",
    priceWas: "$4,994",
  ...
  },
  {
    id: "growth-engine",
    title: "Web App MVP",
    planTagline: "SAAS, PORTALS & DASHBOARDS",
    headerNote:
      "A functional web app MVP with user login, dashboards, database setup, admin tools, integrations, and launch support.",
    priceLead: "$4,997",
    priceWas: "$9,994",
    priceNote: "one-time · 50% off",
    summary: "",
  ...
  },
  {
    ...
    planTagline: "IOS & ANDROID APP MVPS",
    headerNote:
      "A mobile-first MVP for founders and businesses that need user accounts, core app screens, onboarding, integrations, and launch support.",
    priceLead: "$5,997",
    priceWas: "$11,994",
    priceNote: "one-time · 50% off",
    summary: "",
