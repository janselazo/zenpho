...
export const MOCK_WEBSITE_AUDIT: WebsiteAudit = {
  ...
  hasPhoneLink: false,
  hasPhoneText: true,
  hasTextEnabledPhone: true,
  hasPrimaryCta: false,
  hasContactForm: false,
  hasQuoteCta: false,
  hasTestimonials: false,
  homepageFeaturesReviews: false,
  ...
  imageSeo: {
    missingAltAttribute: 2,
    weakOrMissingAlt: 3,
    missingTitle: 4,
    genericFilename: 1,
    largeDeclaredDimensions: 0,
    genericFilenameSamples: ["hero.jpg"],
  },
  pageSpeedImageWasteBytes: null,
